...
% ~~~~~~ Título ~~~~~~ %
\rfoot{Interferencia Electromagnética}
% ~~~~~~ Esquina ~~~~~~ %
...
\include{IntElectro/Intro}

\include{IntElectro/ExperimentoYoung}

\include{IntElectro/CamposEle}

\include{IntElectro/EjemploNum}
\end{document}